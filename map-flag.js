document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isMobile) {
        if (isLandscape) {
            ...
            initialView = { center: [48, 25], zoom: 3 }; 
        } else {
            // VISTA MOBILE VERTICALE (Il tuo originale)
            initialView = { center: [50, 22], zoom: 3 };
        }
    } else {
        // VISTA DESKTOP (Il tuo originale)
        initialView = { center: [44, 30], zoom: 4 };
    }
...
{ name: "Kyiv", nation: "Ukraine", coords: [50.4501, 30.5234], flag: "🇺🇦" }
 ...
 const specialPlaces = [
   // --- TIPOLOGIA: home ---
    ...
    { name: "Stoccarda", type: "viaggi", nation: "Germania", coords: [48.776609541900946, 9.18057343747303], info: "Terme tutti infagottati", date: "Novembre 2023", flag: "🇩🇪" },
