...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (isMobile) {
        if (isLandscape) {
            ...
            initialView = { center: [48, 25], zoom: 3.5 }; 
        } else {
...
{ name: "Kyiv", nation: "Ukraine", coords: [50.4501, 30.5234], flag: "🇺🇦" }
 ...
 const specialPlaces = [
   // --- TIPOLOGIA: home ---
    ...
    { name: "Baia Arena", type: "mare", nation: "Italia", coords: [40.23239780375146, 14.954697709523506], info: "Toccata e fuga <br> con MM family", date: "Luglio 2021", flag: "🇮🇹" },
    ...
    { name: "Spiaggia del Postino", type: "mare", nation: "Italia", coords: [40.76299300071693, 14.009121961808995], info: "CompleFede a <br> Procida", date: "Giugno 2024", flag: "🇮🇹" }, 
 ...
 { name: "Santa Caterina", type: "viaggi", nation: "Italia", coords: [40.142268416018595, 17.983671349275756], info: "Puglia con amiche <br> e family FDB", date: "Agosto 2018", flag: "🇮🇹" }, 
   ...
   { name: "Roma", type: "viaggi", nation: "Italia", coords: [41.899578526349586, 12.472988364982722], info: "Biblioteca EFROME, soppalco, <br> giretti e mangiatine", date: "Ottobre 2019", flag: "🇮🇹" }, 
    ...
    { name: "Culture Hotel", type: "viaggi", nation: "Italia", coords: [40.84441191508071, 14.251797195603405], info: "Guerre di baci, pigiamini <br> e koreani", date: "Gennaio 2026", flag: "🇮🇹" },
     ...
     { name: "Berlino", type: "NextStop", nation: "Germania", coords: [52.521362434199304, 13.396792692182727], info: "Il grande ritorno di FDB,<br> la prima volta di MM, <br>a visitare il Pergamonmuseum e <br>farci rimbalzare al Berghein", date: "???", flag: "🇩🇪" }, 
     ...
     { name: "Tokyo", type: "NextStop", nation: "Giappone", coords: [35.67955981952091, 139.77016952038218], info: "Mi vuoi fa andà solo a me? Sicura?!", date: "???", flag: "🇯🇵" },
     ...
     { name: "Quito", type: "NextStop", nation: "Ecuador", coords: [-0.19482353254652943, -78.50109413965171], info: "e a quel punto che fai? <br> non ci allunghiamo da Ana?! 😝", date: "???", flag: "🇪🇨" },
                    ...
                    if (panel && content) {
                        ...
                        document.getElementById('fly-to-cap').onclick = () => {
                            if (myData && myData.coords) {
                                ...
                                map.flyToBounds(layer.getBounds(), { padding: [50, 50], duration: 8 });
                            }
                        };
                    }
                });
...
specialPlaces.forEach(place => {
    ...
    if (place.type === 'home') {
        layerHome.addLayer(marker);
    } else if (place.type === 'viaggi') {
...
const tutorialSteps = [
    { 
        ...
        testo: "Scegli basemap e attiva layers (Nazioni, Capitali e ATLAS LAYERS)" 
    },
   { 
        id: ".leaflet-control-layers", 
        titolo: "Switcher Mappa", 
...
function showStep() {
    ...
    if (target) {
        ...
        if (isHeartBox) {
            ...
            popupPoint = map.containerPointToLayerPoint([rect.left + 100, rect.top -10]);
        } else {
            // Posizione standard a sinistra dei pulsanti
            popupPoint = map.containerPointToLayerPoint([rect.left - 100, rect.top + 110]);
        }
    }
